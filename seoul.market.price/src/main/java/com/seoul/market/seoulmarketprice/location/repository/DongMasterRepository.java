...
public interface DongMasterRepository extends JpaRepository<DongMaster, Long> {
    ...
    Optional<DongMaster> findByDongNameAndSggSggCode(String dongName, String sggCode);

    Optional<DongMaster> findFirstByDongNameContainingAndSggSggCodeOrderByDongNameAsc(String dongName, String sggCode);

    java.util.List<DongMaster> findAllByDongName(String dongName);
}
